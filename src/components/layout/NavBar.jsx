...
const NavBar = () => { const [menuOpen, setMenuOpen] = useState(false);
  return (
    <nav className="bg-primary h-11 flex items-center select-none text-white">
      <div className="max-w-7xl w-full mx-auto px-8 flex justify-between items-center h-full">
        <div className="bg-primary-hover h-full flex items-center px-5 font-bold text-sm cursor-pointer gap-2.5">
          <i className="fa-solid fa-bars cursor-pointer" onClick={() => setMenuOpen(!menuOpen)}></i>
...
{menuOpen && (
  <div className="md:hidden absolute top-full left-0 w-full bg-primary text-white shadow-lg">
